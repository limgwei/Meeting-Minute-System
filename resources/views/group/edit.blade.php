    ...
    <div class="d-flex flex-column" style="width:100%">
      ...
      <div class="content">
        <div>
          <div class="card">
            <div class="card-body">
              <form enctype="multipart/form-data" action="{{route('groups.update',$group->id)}}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input value="{{$group->title}}" type="text" class="form-control form-control-lg" name="title" placeholder="Title" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Code:</label>
                  <div class="col-lg-9 d-flex">
                    <input value="{{$group->password}}" type="text" class="form-control form-control-lg" disabled id="code">
                    <button type="button" class="btn btn-primary" onclick="change('{{$group->id}}')">
                      Change
                    </button>
                    <div>
                    </div>
                ...
                <div class="text-left" style="float:left">
                  <a class="btn btn-danger text-white" href="{{route('groups.delete',$group->id)}}" method="POST">
                    DELETE
