    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="progress blue">
          ...
          <div class="progress-value"><?php echo e(__('setting.changing_language')); ?></div>
        </div>
...
<div class="padding-5 d-flex flex-column" style="gap:50px;max-width:300px">
  ...
  <div><a href="<?php echo e(route("settings.editProfile")); ?>" class="header_text inter-regular"><?php echo e(__('setting.edit_profile')); ?></a></div>
  <select name="" id="language" class="form-control inter-medium " style="box-sizing: content-box;padding:5px;padding-left:20px">
    ...
    <option value="cn" <?php echo e($locale=="cn"?'selected':''); ?>>中文</option>
  </select>

  <form action="<?php echo e(route("logout")); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <button class="btn btn-danger button_text"><?php echo e(__('setting.logout')); ?></button>
  </form>
...
<script>
  ...
  $("#language").on("change", function() {
    $("#load").click();
    var url = '/<?php echo e(env("base_url")); ?>' + 'settings/change-language';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\minut\resources\views/settings/index.blade.php ENDPATH**/ ?>